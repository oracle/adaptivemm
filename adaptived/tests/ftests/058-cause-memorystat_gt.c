 ...
 */
/**
 * Greater than test for the memory.stat cause
 *
 */
...
static const char * const stat_file = "058-memory.stat";
static const char * const expected_file = "058-cause-memorystat_gt.expected";
static const char * const token_file = "058-cause-memorystat_gt.token";
static const char * const token = "%lld";
static const char *rel_path;

static const long long values[] = { 500 * 1024, 600 * 1024, 700 * 1024, 800 * 1024,
				    900 * 1024, 100 * 1024, 1024 * 1024 + 1 };
static int ctr;
...
int main(int argc, char *argv[])
{
	...
	rel_path = argv[1];
	snprintf(path, FILENAME_MAX - 1, "%s/058-cause-memorystat_gt.json", rel_path);
