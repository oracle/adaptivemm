...
static const char * const setting_file = "061-cause-top_cpu_gt.setting";
...
#define TOP_LINE0	"cpu  2244490039 3881564 530297701 301974353254 19064147 38542716 47012478 0 1920866777 0\n"
...
static int inject(struct adaptived_ctx * const ctx)
{
	...
	if (fp == NULL) {
                adaptived_err("061-cause-top_cpu_gt: can't open %s\n", sample_file);
                return -errno;
        }
	i = 0;
...
int main(int argc, char *argv[])
{
	...
	snprintf(config_path, FILENAME_MAX - 1, "%s/061-cause-top_cpu_gt.json", argv[1]);
