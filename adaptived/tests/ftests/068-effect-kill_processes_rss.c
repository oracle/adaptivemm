...
#define TEST_PROCESS_SRC        "./068_process.c"
#define TEST_PROCESS		"./068_process"
...
static const char * const setting_file = "068-effect-kill_processes_rss.setting";
