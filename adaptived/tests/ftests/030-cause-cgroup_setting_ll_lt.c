...
#define EXPECTED_RET0 -EINVAL
#define EXPECTED_RET -66

static const char * const setting_file = "030-cause-cgroup_setting.setting";
static int ctr = 0;
...
int main(int argc, char *argv[])
{
	...
	snprintf(config_path, FILENAME_MAX - 1, "%s/030-cause-cgroup_setting_ll_lt.json", argv[1]);
	...
	if (ret != EXPECTED_RET0)
		goto err;

	adaptived_dbg("cause-cgroup_setting max check OK.\n");
