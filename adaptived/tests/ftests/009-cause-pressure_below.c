 ...
 */
/**
 * Test for the PSI cause when some_avg10 is less than the specified duration/threshold
 *
 */
...
#define EXPECTED_RET -44

static const char *pressure_file = "009-cause-pressure_below.pressure";
static int ctr = 0;
...
static const float some_avg10[] = {75.1, 20.2, 33.5, 32.1, 31.7, 28.3, 27.8, 31.9, 27.6, 35.5 };
...
int main(int argc, char *argv[])
{
	...
	snprintf(config_path, FILENAME_MAX - 1, "%s/009-cause-pressure_below.json", argv[1]);
