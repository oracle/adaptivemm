...
static const char * const setting_file = "051-cause-slabinfo_gt.setting";
static int ctr = 0;
...
long long expected_value = 172485;
...
int main(int argc, char *argv[])
{
	...
	snprintf(config_path, FILENAME_MAX - 1, "%s/051-cause-slabinfo_gt.json", argv[1]);
