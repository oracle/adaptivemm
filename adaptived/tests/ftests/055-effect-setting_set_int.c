 ...
 */
/**
 * Test to set an integer setting
 *
 */
...
static const char * const setting_file = "./test055.setting";
static const int expected_value = 1133557799;
...
int main(int argc, char *argv[])
{
	...
	snprintf(config_path, FILENAME_MAX - 1, "%s/055-effect-setting_set_int.json", argv[1]);
