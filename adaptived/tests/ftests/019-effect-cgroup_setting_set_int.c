...
static const char * const cgroup_file = "./test019.cgroup";
static const int expected_value = 2468;
...
int main(int argc, char *argv[])
{
	...
	snprintf(config_path, FILENAME_MAX - 1, "%s/019-effect-cgroup_setting_set_int.json", argv[1]);
