 ...
 */
/**
 * Test for the PSI cause when some_avg300 is equal to the specified duration/threshold
 *
 */
...
static const char * const pressure_file = "040-cause-avg300_pressure_equal.pressure";
static int ctr = 0;
...
static const float some_avg300[] = {25.1, 36.2, 13.4, 50.1, 63.8, 54.6, 12.5, 12.5, 12.5, 8.4 };
...
int main(int argc, char *argv[])
{
	...
	snprintf(config_path, FILENAME_MAX - 1, "%s/040-cause-avg300_pressure_equal.json", argv[1]);
