 ...
 */
/**
 * Test for the cgroup_setting cause
 *
 */
...
#define EXPECTED_RET -68

static const char * const setting_file = "032-cause-cgroup_setting.setting";
static int ctr = 0;
...
static float value[] = { 1.999, 1.998, 1.997, 1.996, 1.995, 1.994, };
...
int main(int argc, char *argv[])
{
	...
	snprintf(config_path, FILENAME_MAX - 1, "%s/032-cause-cgroup_setting_float_lt.json", argv[1]);
