...
static const char * const setting_file = "049-cause-meminfo_lt.setting";
static int ctr = 0;
...
static long long value[] = { 493452946, 493452945, 493452944, 493452943, 493452942, 493452941, 493452940 };
...
int main(int argc, char *argv[])
{
	...
	snprintf(config_path, FILENAME_MAX - 1, "%s/049-cause-meminfo_lt.json", argv[1]);
