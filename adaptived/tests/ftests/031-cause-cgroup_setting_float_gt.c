...
#define EXPECTED_RET -67

static const char * const setting_file = "031-cause-cgroup_setting.setting";
static int ctr = 0;
...
static float value[] = { 42.0, 42.1, 42.3, 42.4, 42.5, 42.6 };
...
int main(int argc, char *argv[])
{
	...
	snprintf(config_path, FILENAME_MAX - 1, "%s/031-cause-cgroup_setting_float_gt.json", argv[1]);
