 ...
 */
/**
 * Test for the PSI cause when full_total is greater than the specified duration/threshold
 *
 */
...
static const char *pressure_file = "008-cause-pressure_above_total.pressure";
static int ctr = 0;
...
static const long long full_total[] = {100, 5678, 89278, 1234567890, 1234567890, 1234567890,
				       1234567891, 1234567900, 1234567950, 1234568000, };
...
int main(int argc, char *argv[])
{
	...
	snprintf(config_path, FILENAME_MAX - 1, "%s/008-cause-pressure_above_total.json", argv[1]);
