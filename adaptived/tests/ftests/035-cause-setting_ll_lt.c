...
static const char * const setting_file = "035-cause-setting.setting";
static int ctr = 0;
...
static int value[] = { 10000, 9000, 8000, 7000, 6000, 5000, };
...
int main(int argc, char *argv[])
{
	...
	snprintf(config_path, FILENAME_MAX - 1, "%s/035-cause-setting_ll_lt.json", argv[1]);
