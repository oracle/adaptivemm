...
static const char * const setting_file = "053-cause-slabinfo_eq.setting";
static int ctr = 0;
...
static long long value[] = { 172481, 172482, 172483, 172484, 172485, 172486, 172487 };
long long expected_value = 172484;
...
#define SLABINFO_LINE1	"kmalloc-32        172481  %lld     32  128    1 : tunables    0    0    0 : slabdata   1771   1771      0\n"
...
int main(int argc, char *argv[])
{
	...
	snprintf(config_path, FILENAME_MAX - 1, "%s/053-cause-slabinfo_eq.json", argv[1]);
