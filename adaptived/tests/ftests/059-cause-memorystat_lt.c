 ...
 */
/**
 * Less than test for the memory.stat cause
 *
 */
...
static const char * const stat_file = "059-memory.stat";
static const char * const expected_file = "059-cause-memorystat_lt.expected";
static const char * const token_file = "059-cause-memorystat_lt.token";
static const char * const token = "%lld";
static const char *rel_path;

static const long long values[] = {
	10LL * 1024LL * 1024LL * 1024LL + 5LL,
	10LL * 1024LL * 1024LL * 1024LL + 4LL,
	10LL * 1024LL * 1024LL * 1024LL + 3LL,
	10LL * 1024LL * 1024LL * 1024LL + 2LL,
	10LL * 1024LL * 1024LL * 1024LL + 1LL,
	10LL * 1024LL * 1024LL * 1024LL + 0LL,
	10LL * 1024LL * 1024LL * 1024LL - 1LL,
};
static int ctr;
...
int main(int argc, char *argv[])
{
	...
	rel_path = argv[1];
	snprintf(path, FILENAME_MAX - 1, "%s/059-cause-memorystat_lt.json", rel_path);
	...
	if (ret)
		goto err;
	ret = adaptived_set_attr(ctx, ADAPTIVED_ATTR_INTERVAL, 1200);
	if (ret)
		goto err;
